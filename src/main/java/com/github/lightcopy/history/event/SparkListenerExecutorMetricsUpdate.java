...
public class SparkListenerExecutorMetricsUpdate {
  public static class MetricsUpdate {
    ...
    @SerializedName("Accumulator Updates") public List<AccumulableInfo> updates;
  }

  @SerializedName("Executor ID") public String executorId;
  @SerializedName("Metrics Updated") public MetricsUpdate metrics;
}
